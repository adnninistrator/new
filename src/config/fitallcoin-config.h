...
#ifndef FITALLCOIN_CONFIG_H

#define FITALLCOIN_CONFIG_H
...
#define PACKAGE_NAME "FItAllCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FItAllCoin Core 1.6.2"
